...
{ key: "white-regular-overfit-tee", name: "화이트 레귤러핏 오버핏 반팔티", price: 39000, discountRate: 10, showroom: "어반클로젯 동탄", stock: 12, minutes: 28, match: 91, material: "코튼 100%", visual: "tshirt", category: "상의", fit: "레귤러 기반 오버핏 반팔", size: "M / L / XL", garmentLength: 72, shoulderWidth: 54, chestWidth: 58, waistWidth: 56, modelHeight: 176, modelWeight: 68, note: "화이트 컬러의 기본 반팔티입니다. 레귤러 핏보다 여유 있고 과하지 않은 오버핏이라 데님, 쇼츠, 조거 팬츠에 바로 매칭하기 좋습니다." },
