...
{ key: "jacket", name: "라이트 셔링 재킷", price: 89000, discountRate: 12, showroom: "어반클로젯 동탄", stock: 1, minutes: 32, match: 92, material: "나일론 코튼", visual: "jacket", category: "상의", fit: "살짝 여유 있는 숏 기장", size: "Free / 44-66", note: "퇴근 후 약속에 바로 입기 좋은 가벼운 아우터예요. 링과 함께 담으면 깔끔한 원마일 룩으로 완성됩니다." },
{ key: "shoes", name: "스웨이드 러너 슈즈", price: 129000, discountRate: 8, showroom: "동탄 그레인룸", stock: 4, minutes: 38, match: 88, material: "스웨이드 러버", visual: "shoes", category: "신발", fit: "정사이즈 추천", size: "230-280", note: "부드러운 스웨이드 톤이라 재킷, 데님, 와이드 팬츠에 모두 잘 붙는 데일리 슈즈예요." },
{ key: "bag", name: "미니 호보백", price: 54000, discountRate: 15, showroom: "오산 비트 아카이브", stock: 6, minutes: 41, match: 84, material: "비건 레더", visual: "bag", category: "잡화", fit: "가벼운 데일리 수납", size: "One size", note: "핸드폰, 카드지갑, 립 제품 정도를 넣기 좋은 사이즈예요. 룩에 곡선 포인트를 더해줍니다." },
{ key: "ring", name: "실버 매트 링", price: 26000, discountRate: 5, showroom: "어반클로젯 동탄", stock: 9, minutes: 32, match: 79, material: "스테인리스 스틸", visual: "ring", category: "잡화", fit: "오픈 링 타입", size: "One size", note: "손이 허전해 보일 때 가장 빠르게 룩의 완성도를 올려주는 작은 포인트 아이템이에요." },
];
